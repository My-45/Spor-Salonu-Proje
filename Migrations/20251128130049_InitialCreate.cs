    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HizmetTurleri", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HizmetTurleri_Salonlar_SalonId",
                        column: x => x.SalonId,
                        principalTable: "Salonlar",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AntrenorUzmanliklar", x => new { x.AntrenorId, x.UzmanlikAlaniId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AntrenorUzmanliklar_UzmanlikAlanlari_UzmanlikAlaniId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MusaitlikSaatleri", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Randevular_HizmetTurleri_HizmetTuruId",
                        column: x => x.HizmetTuruId,
                        principalTable: "HizmetTurleri",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AntrenorUzmanliklar_UzmanlikAlaniId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Randevular_HizmetTuruId",
                table: "Randevular",
                column: "HizmetTuruId");
